...
public class HTMLSanitiser {
    ...
    public static String encodeInvalidMarkup(String pseudoHTML, boolean formatWhiteSpace) {
        return sanitise(pseudoHTML, formatWhiteSpace, false, VALID_ELEMENT_NAMES);
    }
    ...
    public static String stripInvalidMarkup(String pseudoHTML, boolean formatWhiteSpace) {
        return sanitise(pseudoHTML, formatWhiteSpace, true, VALID_ELEMENT_NAMES);
    }

    public static String encodeInvalidMarkup(String pseudoHTML, Set<String> allowedElements) {
        return sanitise(pseudoHTML, false, true, allowedElements);
    }

    private static String sanitise(String pseudoHTML,
        ...
        int pos = 0;
        for (Tag tag : tags) {
            if (processTag(tag, outputDocument, allowedElements)) {
    ...
    private static boolean processTag(Tag tag, OutputDocument outputDocument, Set<String> validElements) {
        String elementName = tag.getName();
        if (!validElements.isEmpty() && !validElements.contains(elementName)) return false;
