    ...
    <div class="form-group">
        <div class="form-row">
            ...
            <div class="col-md-2">
                ...
                <g:set var="fopts" value="[all: 'All', name: 'Names', instance: 'Instances', instance_note: 'Instance Notes', reference: 'References', author: 'Authors', tree_element: 'Profiles', comment: 'Comments']"/>
