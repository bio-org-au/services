...
each possible state a modifier i.e. have separate state for each combination, but that would make composition at higher
taxa harder and searching harder e.g.
